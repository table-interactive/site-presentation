      ...
      <article class="space-y-8 mb-10">
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
          ...
          <div class="bg-white p-6 rounded-lg mb-4">
            ...
            <br>
            <p class="text-base text-gray-700 mb-4">
              Le capteur RFID RC522 doit être connecté à l’Arduino Uno en utilisant
              l’interface SPI. Le tableau ci-dessous indique précisément le branchement
              des broches du module RFID vers les broches correspondantes de l’Arduino.
            </p>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
          ...
          <div class="bg-white p-6 rounded-lg mb-4">
            ...
            <ol class="list-decimal pl-6 text-base text-gray-700 space-y-2">
              ...
              <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 mt-4">
                <p class="text-sm text-gray-700">
                  Attention : Assurez-vous que le code fonctionne correctement avec le câblage. Les
                  les broches du modules RFID doivent correspondre à celles définies dans le code. (Exempple :
                  #define RST_PIN 9)
                </p>
              </div>
            </ol>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
          ...
          <div class="bg-white p-6 rounded-lg mb-4">
            ...
            <ol class="list-decimal pl-6 text-base text-gray-700 space-y-2 mb-4">
              ...
              <li>Au besoin, inverser l'écran du Pi
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
          ...
          <div class="bg-white p-6 rounded-lg mb-4">
            ...
            <ul class="list-disc pl-6 text-base text-gray-700 space-y-2 mb-4">
              <li>
                <strong>Capteur ultrasonique :</strong> Placez-le sur le coté
                de la table, dirigés vers le devant pour détecter la présence du
                joueur assis.
                Une fois bien positionné, assurez vous qu'il ne bouge pas et qu'il capte si
                un joueur est présent ou non devant la table.
              </li>
              <li>
                <strong>Capteur RFID :</strong> Fixez-le sur la surface de jeu
                en dessous du tapis de jeu a l'emplacement stratégique où les
                joueurs placeront leurs cartes rfid. Si nécessaire, allongez les Fils reliant
                le capteur au Arduino pour atteindre la position désirée.
              </li>
            </ul>
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mt-4">
              <p class="text-sm text-gray-700">
                ...
                une détection optimale. Si le capteur se trouve trop loin, il est possible
                que les cartes ne soient pas détectées correctement ou même pas du tout.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-8">
          <div class="flex items-center gap-4 mb-6">
            ...
            <h3 class="text-2xl font-bold text-gray-900">
              Installation du logiciel du jeu
            </h3>
          </div>
          <div class="bg-white p-6 rounded-lg mb-4">
            <p class="text-base text-gray-700 mb-4">
            ...
            <ol class="list-decimal pl-6 text-base text-gray-700 space-y-2">
              <li>Copiez les fichiers du jeu sur le Raspberry Pi</li>
              <li>
                Installez les dépendances Python nécessaires (pyserial, pygame,
                etc.)
              </li>
              <li>
                Configurez les paramètres de communication série dans le fichier
                de configuration
              </li>
              <li>
                Testez le lancement du jeu et vérifiez que l'affichage
                fonctionne correctement
              </li>
              <li>
                Configurez le démarrage automatique du jeu au boot du Raspberry
                Pi (optionnel)
              </li>
            </ol>
            <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mt-4">
              <p class="text-sm text-gray-700">
                <strong>Astuce :</strong> Vous pouvez utiliser le site hosté
                pour faciliter la configuration du jeu.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div class="bg-white rounded-lg p-4">
            <div class="aspect-video bg-gray-200 rounded-lg mb-3 flex items-center justify-center">
              <img src="../../public/IMG_0458.JPG" alt="Photo 1: Vue d'ensemble de la table montée"
                class="rounded-lg" />
            </div>
          ...
          <div class="bg-white rounded-lg p-4">
            <div class="aspect-video bg-gray-200 rounded-lg mb-3 flex items-center justify-center">
              <img src="../../public/IMG_0455.JPG" alt="Photo 2: Connexions Arduino et capteurs" class="rounded-lg" />
            </div>
            <p class="text-sm text-gray-600">
          ...
          <div class="bg-white rounded-lg p-4">
            <div class="aspect-video bg-gray-200 rounded-lg mb-3 flex items-center justify-center">
              <img src="../../public/IMG_0452.JPG" alt="Photo 3: Positionnement du projecteur" class="rounded-lg" />
            </div>
            <p class="text-sm text-gray-600">
          ...
          <div class="bg-white rounded-lg p-4">
            <div class="aspect-video bg-gray-200 rounded-lg mb-3 flex items-center justify-center">
              <img src="../../public/IMG_0453.JPG" alt="Photo 4: Capteur RFID sur la surface de jeu"
                class="rounded-lg" />
            </div>
            <p class="text-sm text-gray-600">
